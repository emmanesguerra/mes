            ...
            "columns": [
                ...
                {"data": "updated_at"},
                {
                    ...
                    mRender: function (data, type, full) {
                        var straction = "";
                        @can('slider-edit')
                            straction += "<a href='{{ route('admin.sliders.index') }}/" + full.id + "/edit'>Edit</a>";
                        @endcan
                        @can('slider-list')
                            straction +=  " | <a href='{{ route('admin.sliders.index') }}/" + full.id + "'>View Details</a>";
                        @endcan
                        @can('slider-delete')
                            straction += ' | <a href="#" onclick="showdeletemodal(' + full.id + ',\''+full.title+'\', \'{{ route("admin.sliders.index") }}\/' + full.id + '\')" class="text-danger">Delete</a>';
                        @endcan
                        return straction;
                    }
                }
