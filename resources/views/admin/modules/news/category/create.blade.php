    ...
    <div class="row">
        <div class="card" style="width: 100%">
            ...
            <div class="card-body">
                ...
                {!! Form::open(array('route' => 'admin.newscategory.store','method'=>'POST', 'files'=>true)) !!}
                <div class="row">
                        ...
                        <div class="col-sm-12">
                            <div class="form-row">
                                <div  class="form-group  col-sm-12">
                                    ...
                                    <input maxlength="191" type="text" class="form-control ae-input-field @error('name') is-invalid @enderror " name="name" value="{{ old('name') }}" id="name" placeholder="Name"/>
