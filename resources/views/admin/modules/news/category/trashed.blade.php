                ...
                {"data": "updated_at"},
                {
                    ...
                    mRender: function (data, type, full) {
                        ...
                        @can('newscategory-restore')
                            straction +=  "<a href='{{ route('admin.newscategory.restore') }}/" + full.id + "'>View Details</a>";
                        @endcan
                        @can('newscategory-fdelete')
                            straction += ' | <br /> <a href="#" onclick="showdeletemodal(' + full.id + ',\''+full.name+'\', \'{{ route("admin.newscategory.forcedelete") }}\/' + full.id + '\')" class="text-danger">Delete Permanently</a>';
                        @endcan
                        return straction;
                    }
                }
