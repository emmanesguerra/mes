    ...
    <div class="row">
        <div class="card" style="width: 100%">
            ...
            <div class="card-body">
                ...
                {!! Form::open(array('route' => 'admin.newsletters.store','method'=>'POST', 'files'=>true)) !!}
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-12">
                        <div class="col-sm-12">
                            ...
                            <div class="form-row">
                                <tinymce-form  :value="{{ (Session::getOldInput('content')) ? json_encode(Session::getOldInput('content')): json_encode(null) }}"
