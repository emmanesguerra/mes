                        ...
                        <div class="col-sm-12">
                            <div class="form-row">
                                <div  class="form-group  col-sm-7">
                                    ...
                                    <input minlength="4" maxlength="50" type="text" class="form-control ae-input-field @error('name') is-invalid @enderror " name="name" value="{{ old('name') }}" id="name" placeholder="Name" required/>
                            ...
                            <div class="form-row">
                                ...
                                <div  class="form-group  col-sm-5">
                                    ...
                                    <input minlength="1" maxlength="100" type="text" class="form-control ae-input-field @error('url') is-invalid @enderror " name="url" value="{{ old('url') }}" id="url" placeholder="Slug" required/>
